...
{
    /// <summary>Encapsulates an array of bytes and gives methods to read different data types off the stream.</summary>
    class ByteStream
    {
        byte[] data;
        int index = 0;
        ...
        {
            return new Vector2(PeekFloat(), BitConverter.ToSingle(data, index + 4));
        }
        ...
        {
            Vector2[] r = new Vector2[ReadInt32()];
